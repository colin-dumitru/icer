    ...
    $.widget("ui.draggable", $.ui.mouse, {
        ...
        _mouseDrag: function (event, noPropagation) {
            ...
            if (!this.options.axis || this.options.axis !== "y") {
                this.helperj.css({
                    WebkitTransform: "translate3d(" + this.position.left + "px, 0, 0)",
                    transform: "translate3d(" + this.position.left + "px, 0, 0)"
                });
            }
            if (!this.options.axis || this.options.axis !== "x") {
                this.helperj.css({
                    WebkitTransform: "translate3d(0, " + this.position.top + "px, 0)",
                    transform: "translate3d(0, " + this.position.top + "px, 0)"
                });
            }
            if ($.ui.ddmanager) {
